import{_ as a,c as i,o as n,ag as l}from"./chunks/framework.CQuhCYrb.js";const o=JSON.parse('{"title":"Markdown扩展示例","description":"","frontmatter":{},"headers":[],"relativePath":"zh-CN/Model-Innovation.md","filePath":"zh-CN/Model-Innovation.md"}'),p={name:"zh-CN/Model-Innovation.md"};function t(e,s,h,k,r,E){return n(),i("div",null,[...s[0]||(s[0]=[l(`<h1 id="markdown扩展示例" tabindex="-1">Markdown扩展示例 <a class="header-anchor" href="#markdown扩展示例" aria-label="Permalink to &quot;Markdown扩展示例&quot;">​</a></h1><p>本页展示了VitePress提供的一些内置markdown扩展。</p><h2 id="语法高亮" tabindex="-1">语法高亮 <a class="header-anchor" href="#语法高亮" aria-label="Permalink to &quot;语法高亮&quot;">​</a></h2><p>VitePress提供了由<a href="https://github.com/shikijs/shiki" target="_blank" rel="noreferrer">Shiki</a>支持的语法高亮，还具有行高亮等附加功能：</p><p><strong>输入</strong></p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">\`\`\`js{4}</span></span>
